<div style="margin:10px 0px; font-size:50px; text-align:center;">🖥️ Windows 11</div>
...
<div style="text-align:center;">
    <img src="public/screenshots/desktop.png" alt="desktop" width="400px" style="margin: 10px;">
    <img src="public/screenshots/lockscreen.png" alt="lockscreen" width="400px" style="margin: 10px;">
    <p><strong>You can enter anything on the login page to gain access to the app. No need for actual credentials!</strong></p>
</div>
